(function () { 
    ...
    angular.module('app').controller(controllerId,
        ['$route', '$rootScope', 'config', 'routes', sidebar]);

    function sidebar($route,$rootScope, config, routes) {
        var vm = this;
        ...
        function getNavRoutes() {
            ...
            //    if (route && route.access && route.access.requiredPermissions)
            //        return authentication.hasPermission(route.access.requiredPermissions);
            //    return true;
            //});

            var orderedRoutes = _.sortBy(
               _.reject((_.where($route.routes, !{ level: 1, parentId: 0 })), function (route) {
