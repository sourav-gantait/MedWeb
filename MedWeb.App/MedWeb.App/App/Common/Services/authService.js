...
angular.module('app').factory('authService', ['$http', '$q', 'localStorageService', 'ngAuthSettings', function ($http, $q, localStorageService, ngAuthSettings) {
    ...
    var saveRegistration = function (registration) {
        logOut();
        var param =JSON.stringify(CreateRegistrationInput(registration));
       // return $http.post("http://medwebusers.azurewebsites.net/" + 'api/CitizenLocationDigitalMasters/SignUpCitizen', param, { headers: { 'Content-Type': 'application/json;charset=utf-8' } }).then(function (response) {

        return $http.post("http://localhost:50414/" + 'api/CitizenLocationDigitalMasters/SignUpCitizen', param, { headers: { 'Content-Type': 'application/json; charset=UTF-8' } }).then(function (response) {
                //return $http.post("http://localhost:50414/" + 'api/CitizenLocationDigitalMasters/SignUpCitizen', param, {
        //    headers: {'Content-Type': 'application/json;charset=utf-8', 'dataType': 'jsonp'}
